                      ...
                      child: Column(
                        children: <Widget>[
                          ListTile(
                            ...
                            subtitle: Text(
                              'Nombre del torneo: ${torneo.nombreTorneo} Dirección del torneo: ${torneo.direccion} Diciplina del Torneo : ${torneo.diciplina} Cantidad de equipos particpantes : ${torneo.cantidadEquipos} Cantidad de rondas : ${torneo.cantidadRondas} ¿Aceptan personas Discpacitdad? : ${torneo.personasMovilidad}',
                              style: const TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 12),
